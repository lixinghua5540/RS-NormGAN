...
def ssim(img1, img2, window_size=11, window=None, size_average=False, full=False, val_range=None):
...
def msssim(img1, img2, window_size=11, size_average=False, val_range=None, normalize=False):
